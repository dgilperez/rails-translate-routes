...
# -*- encoding: utf-8 -*-
# stub: rails-translate-routes 0.1.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2014-12-23"
  s.description = "Simple gem to translate routes in Rails 3.2 and Rails 4 based on translate_routes"
  ...
  s.summary = "Simple gem to translate routes in Rails 3.2 and Rails 4"
